DELETE FROM `quest_template` WHERE  `id` = 805025;
DELETE FROM `quest_template_addon` WHERE `id` = 805025;
DELETE FROM `creature_questender` WHERE `id` = 800026   AND `quest` = 805025;
DELETE FROM `creature_queststarter` WHERE `id` = 800026   AND `quest` = 805025;
...
(/*  ID    */805025,
 ...
 /*  PointY  */ 0,
 /*  PointOption  */ 0,
 /*  LogTitle  */ 'Partyvorbereitung',
 /*  LogDescription  */  'Besorgt die Dekoration.',
 /*  QuestDescription   */ 'Ich feier gerne und deswegen schmeisse ich nun jeden Tag eine Party, aber ich brauch noch Hilfe bei der Dekoration.$B$BKönntest du mir noch paar Sachen besorgen?',
 /*  EndText */  '',
 /*  OfferRewardText bevor man beendet  */  'Wunderbar $C, jetzt kann die Party am Abend beginnen.',
 /*  RequestItemsText  */ 'Hey $N, hast du die Dekoration schon',
 /*  Quest Completed Text wird rechts im Questlog angezeigt der Text */ 'Legt die Dekoration in die Truhe!',
 /*  RequiredNpcOrGo1  */ 0,
 /*  RequiredNpcOrGo2  */ 0,
 /*  RequiredNpcOrGo3  */ 0,
 /*  RequiredNpcOrGo4  */ 0,
 ...
 /*  RequiredItemId1  */ 23771,
 /*  RequiredItemId2  */ 25886,
 /*  RequiredItemId3  */ 23768,
 /*  RequiredItemId4  */ 0,
 /*  RequiredItemId5  */ 0,
 /*  RequiredItemId6  */ 0,
