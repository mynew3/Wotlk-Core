...
DELETE FROM `quest_template_addon` WHERE `id` = 9000001;
DELETE FROM `creature_questender` WHERE `id` = 33587   AND `quest` = 9000001;
DELETE FROM `creature_queststarter` WHERE `id` = 32685   AND `quest` = 9000001;
